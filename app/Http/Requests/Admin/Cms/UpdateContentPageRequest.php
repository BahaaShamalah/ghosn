...
class UpdateContentPageRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        if (! $this->filled('slug') && $contentPage) {
            $this->merge(['slug' => $contentPage->slug]);
        }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['required', 'string', 'max:255', 'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/', Rule::unique('content_pages', 'slug')->ignore($contentPage->id), new NotReservedContentPageSlug],
